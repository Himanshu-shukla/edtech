...
import { getCoursesData, getCompanyInfoData } from '../lib/dataAdapter';
import type { Course, CompanyInfo } from '../lib/types';
        ...
        <div className="grid md:grid-cols-12 gap-12 mb-16">
          ...
          <div className="md:col-span-3 md:pl-8">
            ...
            <ul className="space-y-4">
              ...
              <li className="pt-2">
                <Link href="/programs" className="text-emerald-400 text-sm font-semibold hover:text-emerald-300 flex items-center gap-1">
