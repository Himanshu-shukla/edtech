...
import { getCoursePricingData, getPricingFAQ, getCourseBenefitsComparison } from "../../lib/dataAdapter";
import type { CoursePricing, PricingFAQ, CourseBenefit } from "../../lib/types";
                ...
                <section className="relative md:py-12 overflow-hidden">
                    ...
                    <div className="relative mx-auto max-w-7xl px-6 text-center z-10">
                        ...
                        >
                            ...
                            <h1 className="text-5xl md:text-7xl font-extrabold mb-8 tracking-tight leading-tight text-white">
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="mb-8 p-6 rounded-2xl bg-zinc-950/50 border border-zinc-800/50 text-center">
                                            ...
                                            {paymentMode === 'one-time' && pricing.savings > 0 && (
