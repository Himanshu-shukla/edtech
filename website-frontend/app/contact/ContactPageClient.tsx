                ...
                <section className="relative py-20 md:py-32 overflow-hidden">
                    ...
                    <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
                        ...
                        <motion.h1
                            ...
                            className="text-5xl md:text-7xl font-extrabold mb-8 tracking-tight leading-tight text-white"
                        >
                        ...
                        <div className="max-w-7xl mx-auto px-6 relative z-10">
                            <div className="grid lg:grid-cols-2 gap-16 items-start">
                                ...
                                >
                                    ...
                                    <div className="mb-8">
                                        <div className="text-2xl font-bold text-white mb-2 text-white">Send a Message</div>
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-5">
                                        ...
                                        <button
                                            ...
                                            className={`w-full py-4 rounded-xl font-bold text-sm transition-all duration-300 flex items-center justify-center gap-2 shadow-lg ${isSubmitting
